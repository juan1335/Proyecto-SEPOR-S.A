...
class ListCompraMateriaPr(models.Model):
    id_compra = models.IntegerField(primary_key=True)
    id_materia_prima = models.ForeignKey(TMateriaPrima, on_delete=models.CASCADE)
    id_proveedor = models.ForeignKey(TProveedor, on_delete=models.CASCADE)
    materia_prima = models.TextField(max_length=200)
    proveedor = models.TextField(max_length=200)
    cantidad = models.IntegerField()
    importe = models.DecimalField(max_digits=10, decimal_places=4)
